...
void drawMaze()
{
	...
	WallTex(22, 0, -45, 30, 4, -47, texWall); //13
	...
	WallTex(7, 0, -59, -50, 4, -61, texWall); //24
	...
	WallTex(-21, 0, -29,  -23, 4, -34, texWall); //37
	...
	WallTex(23, 0, 48,  67, 4, 50, texWall); //76
	WallTex(46, 0, 48,  48, 4, 42, texWall); //77
	WallTex(46, 0, 40,  55, 4, 42, texWall); //78
	
	WallTex(67, 0, 50,  69, 4, 0, texWall); //79
	...
	WallTex(53, 0, -5,  55, 4, 5, texWall); //97
	WallTex(53, 0, 5, 39, 4, 7, texWall); //98
	WallTex(39, 0, 17,  41, 4, -6, texWall); //99
	WallTex(27, 0, 17,  39, 4, 19, texWall); //100
	WallTex(34, 0, -6,  39, 4, -4, texWall); //101
	WallTex(32, 0, -6,  34, 4, 0, texWall); //102
	
	WallTex(46, 0, 5,   48, 4, -13, texWall); //103
	WallTex(30, 0, -11,  48, 4, -13, texWall); //104
	WallTex(30, 0, -13,  32, 4, -27, texWall); //105
	WallTex(32, 0, -25,  41, 4, -27, texWall); //106
	
	WallTex(17, 0, -32,  48, 4, -34, texWall); //107
	WallTex(46, 0, -18,  48, 4, -34, texWall); //108
	WallTex(37, 0, -18,  46, 4, -20, texWall); //109
	
	WallTex(30, 0, -39,  37, 4, -41, texWall); //110
	WallTex(35, 0, -41,  37, 4, -55, texWall); //111
	WallTex(37, 0, -53,  44, 4, -55, texWall); //112
	
	WallTex(17, 0, -52,  19, 4, -61, texWall); //113
	WallTex(17, 0, -59,  30, 4, -61, texWall); //114
